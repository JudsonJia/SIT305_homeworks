...
public class Quiz extends AppCompatActivity {
    ...
    private void checkAnswer(int selectedOptionIndex, RadioButton clicked) {
        if (questions != null && !questions.isEmpty() && currentQuestionIndex < questions.size()) {
            ...
            insertQuestionsToDB(currentQuestion, currentQuestion.getOptions().get(selectedOptionIndex), currentQuestion.getCorrectAnswer());
                    ...
                    public void run() {
                        ...
                        MyAccount.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(Quiz.this, MyAccountActivity.class);
    ...
    public void insertQuestionsToDB(Question question, String userAnswer, String correctAnswer) {
        DBHelper dbHelper = new DBHelper(Quiz.this);
        dbHelper.insertQuizContent(username,
